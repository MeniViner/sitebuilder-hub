...
const deterministicEnv = {
  ...
  CLIENT_ORIGINS: "http://localhost:5177,http://127.0.0.1:5177,https://portal.army.idf",
  AUTH_ENABLED: "false",
  ...
  SITE_BUILDER_BACKEND_DEFAULT_API_KEY_REF: "",
  SITE_BUILDER_DEFAULT_STORAGE_BACKEND: "unknown",
  HUB_ADVANCED_MANUAL_SITE_FIELDS_ENABLED: "true",
