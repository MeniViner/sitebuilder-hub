...
const envSchema = z.object({
  ...
  SITE_BUILDER_BACKEND_API_URLS: z.string().default(""),
  SITE_BUILDER_DEFAULT_BACKEND_API_URL: z.string().default(""),
  SITE_BUILDER_DEFAULT_BACKEND_LABEL: z.string().default(""),
  ...
  HUB_DANGEROUS_ALLOW_DEPLOY_WITHOUT_BACKUP: booleanFromEnv.default(false),
  HUB_DANGEROUS_ALLOW_ROLLBACK_WITHOUT_BACKUP: booleanFromEnv.default(false),
  HUB_DANGEROUS_ALLOW_RESTORE_WITHOUT_BACKUP: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_ALL_VALIDATION_GATES: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_APPROVAL_GATES: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_SHAREPOINT_WRITE_GATES: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_RELEASE_ARTIFACT_VALIDATION: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_DEPLOY_PLAN_BLOCKERS: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_RESTORE_EVIDENCE_GATES: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_BROWSER_EVIDENCE_GATES: booleanFromEnv.default(false),
  HUB_DANGEROUS_BYPASS_ADMIN_REPAIR_GATES: booleanFromEnv.default(false),
...
const parsed = envSchema.safeParse({
  ...
  SITE_BUILDER_BACKEND_API_URLS: process.env.SITE_BUILDER_BACKEND_API_URLS,
  SITE_BUILDER_DEFAULT_BACKEND_API_URL: process.env.SITE_BUILDER_DEFAULT_BACKEND_API_URL,
  SITE_BUILDER_DEFAULT_BACKEND_LABEL: process.env.SITE_BUILDER_DEFAULT_BACKEND_LABEL,
  ...
  HUB_DANGEROUS_ALLOW_DEPLOY_WITHOUT_BACKUP: process.env.HUB_DANGEROUS_ALLOW_DEPLOY_WITHOUT_BACKUP,
  HUB_DANGEROUS_ALLOW_ROLLBACK_WITHOUT_BACKUP: process.env.HUB_DANGEROUS_ALLOW_ROLLBACK_WITHOUT_BACKUP,
  HUB_DANGEROUS_ALLOW_RESTORE_WITHOUT_BACKUP: process.env.HUB_DANGEROUS_ALLOW_RESTORE_WITHOUT_BACKUP,
  HUB_DANGEROUS_BYPASS_ALL_VALIDATION_GATES: process.env.HUB_DANGEROUS_BYPASS_ALL_VALIDATION_GATES,
  HUB_DANGEROUS_BYPASS_APPROVAL_GATES: process.env.HUB_DANGEROUS_BYPASS_APPROVAL_GATES,
  HUB_DANGEROUS_BYPASS_SHAREPOINT_WRITE_GATES: process.env.HUB_DANGEROUS_BYPASS_SHAREPOINT_WRITE_GATES,
  HUB_DANGEROUS_BYPASS_RELEASE_ARTIFACT_VALIDATION: process.env.HUB_DANGEROUS_BYPASS_RELEASE_ARTIFACT_VALIDATION,
  HUB_DANGEROUS_BYPASS_DEPLOY_PLAN_BLOCKERS: process.env.HUB_DANGEROUS_BYPASS_DEPLOY_PLAN_BLOCKERS,
  HUB_DANGEROUS_BYPASS_RESTORE_EVIDENCE_GATES: process.env.HUB_DANGEROUS_BYPASS_RESTORE_EVIDENCE_GATES,
  HUB_DANGEROUS_BYPASS_BROWSER_EVIDENCE_GATES: process.env.HUB_DANGEROUS_BYPASS_BROWSER_EVIDENCE_GATES,
  HUB_DANGEROUS_BYPASS_ADMIN_REPAIR_GATES: process.env.HUB_DANGEROUS_BYPASS_ADMIN_REPAIR_GATES,
